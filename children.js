var DB_CHILDREN = [
    ...
    },
    {
        ...
        "计算结果": "function(v){ return '本量表为静态参考表，请查看下方标准数据'; }",
        "参考表": [
            { "临床疾病类型": "吸气峰压 PIP (cmH₂O)", "呼气末正压 PEEP (cmH₂O)", "呼吸频率 RR (次/分)", "吸气时间 Ti (秒)", "核心通气策略与注意事项" },
            ...
            { "临床疾病类型": "新生儿呼吸窘迫综合征 (RDS) (肺顺应性极低)", "吸气峰压 PIP (cmH₂O)": "20 ~ 25", "呼气末正压 PEEP (cmH₂O)": "5 ~ 6", "呼吸频率 RR (次/分)": "40 ~ 60", "吸气时间 Ti (秒)": "0.3 ~ 0.4", "核心通气策略与注意事项": "肺泡萎陷严重，需较高 PEEP 维持肺复张；因顺应性差，PIP需较高才能送入足够潮气量(4-6ml/kg)。使用表面活性物质后顺应性骤增，必须迅速下调PIP以防气胸。" },
